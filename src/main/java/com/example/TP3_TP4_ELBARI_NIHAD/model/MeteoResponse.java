package com.example.TP3_TP4_ELBARI_NIHAD.model;

public class MeteoResponse {

    private DailyForecastItem[] forecast;  // Array of forecast items for each day

    // Getters and Setters for forecast
    ...
    // Inner class to represent daily forecast data
    public static class DailyForecastItem {
        private int day;  // Day number (0 for today)
