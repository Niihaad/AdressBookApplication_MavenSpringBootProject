...
import com.example.TP3_TP4_ELBARI_NIHAD.service.GeographyService;
import com.example.TP3_TP4_ELBARI_NIHAD.model.EtalabResponse;
import com.example.TP3_TP4_ELBARI_NIHAD.model.MeteoResponse;
import com.example.TP3_TP4_ELBARI_NIHAD.model.MeteoResponse.DailyForecastItem;
...
public class MeteoController {
    ...
    public MeteoController(GeographyService geoService) {
    ...
    public String getMeteo(@RequestParam(name = "address") String address, Model model) {
        ...
        if (etalabResponse != null && !etalabResponse.getFeatures().isEmpty()) {
            ...
            String apiUrl = "https://api.meteo-concept.com/api/forecast/daily?token=77968e5d3fd016867e01617ed6343f0ea841b40e3e82db570c57c4fab04f1ca0&latlng="+longitude+","+latitude;

            RestTemplate restTemplate = new RestTemplate();
            MeteoResponse meteoResponse = restTemplate.getForObject(apiUrl, MeteoResponse.class);

            System.out.println("urll "+apiUrl);
